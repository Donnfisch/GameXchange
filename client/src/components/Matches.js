...
class Matches extends Component {
  ...
  generateRequest = () => {
    ...
    const message = `Dear ${outboundTrade[0].user.username},%0A%0A  This is an autogenerated email from gameXchange. The gameXchange user USERID would like to offer the following trade:`;
