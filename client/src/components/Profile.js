    ...
    <Container fluid>
      ...
      <Card>
        <div className= "mainContent">
          <Card.Content>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus non sollicitudin mi. Proin arcu erat, varius sit amet orci id, commodo volutpat purus. Suspendisse et sem in augue imperdiet pretium eget ac lacus. Integer vulputate purus et risus molestie, eget venenatis elit lacinia. Proin lacinia nulla sit amet libero imperdiet faucibus. Fusce lacinia at odio sed lacinia. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla efficitur tellus ut condimentum ullamcorper. Nullam justo dolor, venenatis ac augue id, varius dignissim tortor. Nam dictum sed tortor et sagittis. Integer lobortis lacus et tempus consectetur. Duis euismod, metus at aliquam sodales, ipsum risus scelerisque metus, ut bibendum metus massa at erat. Nullam dictum ultricies fringilla. In maximus libero massa, id facilisis augue maximus sit amet.</p>
          </Card.Content>
        </div>
      </Card>
    </Container>
